    ...
    <form action=" {{route('admin.restaurants.dishes.update',[$restaurant, $dish->id])}}" method="POST"
        ...
        <div class="form-group white">
            ...
            <input type="text" class="form-control" id="nome_prodotto" placeholder="nome prodotto" name="nome_prodotto"
                value="{{ old( 'nome_prodotto', $dish->nome_prodotto) }}">
        </div>
        ...
        <div class="form-group white mt-5">
            ...
            <div>
                <textarea class="w-100" name="description" id="description" cols="30" rows="10" placeholder="descrizione">
        ...
        <div class="form-group white mt-3">
            ...
            <input type="checkbox" id="glutine" name="glutine" @if(old('glutine', $dish->glutine) == 1) checked @endif
            value="1"
            >
        </div>
        <div class="form-group white">
            ...
            <input type="checkbox" id="vegetariano" name="vegetariano" @if(old('vegetariano', $dish->vegetariano) == 1)
            checked @endif
            value="1"
            >
        </div>
